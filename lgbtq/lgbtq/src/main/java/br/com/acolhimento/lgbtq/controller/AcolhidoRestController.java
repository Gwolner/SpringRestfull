...
//		}
	...
	public ResponseEntity<String> autenticarAcolhido(@RequestBody Acolhido acolhido){		
		try {
			String cpfAcolhido = Fachada.getCurrentInstance().autenticacaoAcolhido(acolhido.getEmail(), acolhido.getSenha());
